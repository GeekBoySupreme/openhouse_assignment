...
function showdemo()
{
    ...
    document.getElementById('container-subject').innerHTML='';
                ...
                function getTemplate(subject) {
                    ...
                    <h6 id="description">Pick a date</h6><div id="'+ subject_id_1 +'" class="widget_panel">\
                    ...
                    \ <h6 id="description">Pick a date</h6><div id="'+ subject_id_2 +'" class="widget_panel">\
                    ...
                    </div> <h6 id="description">Pick a date</h6>\
